...
;(function (window, document, undefined) {
        ...
        $.fn.extend({
            ...
            serializeArray: function () {
                ...
                $(slice.call(ele.elements)).each(function () {
                    ...
                    type = $ele.attr('type');
                    if (
                        this.nodeName.toLowerCase() !== 'fieldset' && !this.disabled &&
    ...
    mdui.Headroom = (function () {
        ...
        Headroom.prototype.pin = function () {
            ...
            if (
                _this.state === 'pinning' ||
                _this.state === 'pinned' || !_this.$headroom.hasClass(_this.options.initialClass)
            ) {
                return;
            }
        ...
        Headroom.prototype.unpin = function () {
            ...
            if (
                ...
                _this.state === 'unpinned' || !_this.$headroom.hasClass(_this.options.initialClass)
            ) {
                return;
            }
    ...
    mdui.Menu = (function () {
        ...
        function Menu(anchorSelector, menuSelector, opts) {
            ...
            $document.on('click touchstart', function (e) {
                var $target = $(e.target);
                if (
                    (_this.state === 'opening' || _this.state === 'opened') && !$target.is(_this.$menu) && !$.contains(_this.$menu[0], $target[0]) && !$target.is(_this.$anchor) && !$.contains(_this.$anchor[0], $target[0])
                ) {
                    _this.close();
                }
            });
